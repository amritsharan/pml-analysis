...
print(paste("Best tuning parameter (mtry):", model_rf$bestTune$mtry))
...
#Predict on test set
final_pred <- predict(model_rf, test_data)
...
2. **5-fold cross-validation**: Balances computational efficiency with robust error estimation. The consistent accuracy across folds (±0.19% SD) indicates stable model performance.
